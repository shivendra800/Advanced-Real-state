...
class AgentPropertyController extends Controller
{
    ...
    {
        $property =Property::where('agent_id',Auth::id())->latest()->get();
    ...
    public function AgentEditProperty($id)
    {
        ...
        return view('agent.property.edit_property',compact('propertytype','amenities','activeAgent','property','property_ami','multiImage','facilities'));
    }
    ...
    public function AgentDetailsProperty($id)
    {
        ...
        $amenities = Amenities::latest()->get();
        $activeAgent = User::where('status','active')->where('role','agent')->latest()->get();
        return view('agent.property.details_property',compact('property','property_ami','amenities'));
    }
    ...
    public function StoreBusinessPlan(Request $request)
    {
        ...
        PackagePlan::insert([
            ...
            'package_credits' =>'3',
            'invoice' => 'Shiv' .mt_rand(10000000,90000000),
            'package_amount' => '20',
            'created_at' =>Carbon::now(),
        ]);
        ...
        $notification = array(
            'message' =>"You Have Purchase Business Plan  Successfully!",
            'alert-type' =>'success'
        );

      return redirect('/agent/all/property')->with($notification);
    }
    ...
    public function StoreProfessionalPlan(Request $request)
    {
        ...
        $notification = array(
            'message' =>"You Have Purchase Professional Plan  Successfully!",
            'alert-type' =>'success'
        );

                        ...
                        <div class="post-inner">
                            <div class="post">
                                <figure class="post-thumb"><a href="blog-details.html">
                                        <img src="{{(!empty($userData->photo)) ? url('upload/user_images/'.$userData->photo) : url('upload/pada.jpeg')}}" alt=""></a></figure>
                                <h5><a href="blog-details.html">Shivendra Tripathi </a></h5>
                                <p>Shivendra@gmail.com </p>
                            </div>
                        </div>
                    </div>

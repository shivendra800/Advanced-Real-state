<div class="sidebar-widget category-widget">
    ...
    <div class="widget-content">
        <ul class="category-list ">
            ...
            <li><a href="{{ url('user-profile') }}"><i class="fa fa-cog" aria-hidden="true"></i> Settings</a></li>
            ...
            <li><a href="{{ url('user-logout') }}"><i class="fa fa-chevron-circle-up" aria-hidden="true"></i> Logout </a></li>
        </ul>
    </div>
</div>